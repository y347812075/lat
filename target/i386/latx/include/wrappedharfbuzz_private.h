...
GOM(hb_blob_get_empty, pFEv)
GO(hb_blob_get_length, uFp)
GOM(hb_blob_get_user_data, pFEpp)
...
GO(hb_buffer_get_random_state, uFp)
...
GOM(hb_buffer_get_user_data, pFEpp)
...
GO(hb_buffer_set_random_state, vFpu)
...
GOM(hb_color_line_get_color_stops, uFEpupp)
GOM(hb_color_line_get_extend, uFEp)
...
GO(hb_draw_funcs_get_empty, pFv)
GOM(hb_draw_funcs_get_user_data, pFEpp)
...
GOM(hb_draw_funcs_set_user_data, iFEppppi)
...
GO(hb_face_collect_nominal_glyph_mapping, vFppp)
...
GO(hb_font_paint_glyph, vFpuppuu)
...
GO(hb_font_set_synthetic_bold, vFpffi)
...
GO(hb_font_set_variation, vFpuf)
...
GOM(hb_graphite2_face_get_gr_face, pFEp)
GOM(hb_graphite2_font_get_gr_font, pFEp)
...
GO(hb_ot_layout_collect_features_map, vFpuuup)
...
GO(hb_ot_layout_get_baseline2, iFpuuupp)
GO(hb_ot_layout_get_baseline_with_fallback, vFpuuuup)
GO(hb_ot_layout_get_baseline_with_fallback2, vFpuuupp)
GO(hb_ot_layout_get_font_extents, iFpuuup)
GO(hb_ot_layout_get_font_extents2, iFpuupp)
...
GO(hb_ot_layout_script_select_language2, iFpuuuppp)
...
GO(hb_paint_color, vFppiu)
GO(hb_paint_color_glyph, iFppup)
GO(hb_paint_custom_palette_color, iFppup)
GO(hb_paint_funcs_create, pFv)
GO(hb_paint_funcs_destroy, vFp)
GO(hb_paint_funcs_get_empty, pFv)
GOM(hb_paint_funcs_get_user_data, pFEpp)
GO(hb_paint_funcs_is_immutable, iFp)
GO(hb_paint_funcs_make_immutable, vFp)
GO(hb_paint_funcs_reference, pFp)
GOM(hb_paint_funcs_set_color_func, vFEpppp)
GOM(hb_paint_funcs_set_color_glyph_func, vFEpppp)
GOM(hb_paint_funcs_set_custom_palette_color_func, vFEpppp)
GOM(hb_paint_funcs_set_image_func, vFEpppp)
GOM(hb_paint_funcs_set_linear_gradient_func, vFEpppp)
GOM(hb_paint_funcs_set_pop_clip_func, vFEpppp)
GOM(hb_paint_funcs_set_pop_group_func, vFEpppp)
GOM(hb_paint_funcs_set_pop_transform_func, vFEpppp)
GOM(hb_paint_funcs_set_push_clip_glyph_func, vFEpppp)
GOM(hb_paint_funcs_set_push_clip_rectangle_func, vFEpppp)
GOM(hb_paint_funcs_set_push_group_func, vFEpppp)
GOM(hb_paint_funcs_set_push_transform_func, vFEpppp)
GOM(hb_paint_funcs_set_radial_gradient_func, vFEpppp)
GOM(hb_paint_funcs_set_sweep_gradient_func, vFEpppp)
GOM(hb_paint_funcs_set_user_data, iFEppppi)
GO(hb_paint_image, vFpppuuufp)
GOM(hb_paint_linear_gradient, vFEpppffffff)
GO(hb_paint_pop_clip, vFpp)
GO(hb_paint_pop_group, vFppu)
GO(hb_paint_pop_transform, vFpp)
GO(hb_paint_push_clip_glyph, vFppup)
GO(hb_paint_push_clip_rectangle, vFppffff)
GO(hb_paint_push_group, vFpp)
GO(hb_paint_push_transform, vFppffffff)
GOM(hb_paint_radial_gradient, vFEpppffffff)
GOM(hb_paint_sweep_gradient, vFEpppffff)
...
GOM(hb_set_get_user_data, pFEpp)
GO(hb_set_has, iFpu)
GO(hb_set_hash, uFp)
...
GOM(hb_shape_plan_get_user_data, pFEpp)
...
GOM(hb_unicode_funcs_get_user_data, pFEpp)
