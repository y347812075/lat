...
GO(cairo_font_options_get_color_mode, uFp)
GO(cairo_font_options_get_color_palette, uFp)
GO(cairo_font_options_get_custom_palette_color, uFpupppp)
...
GO(cairo_font_options_get_variations, pFp)
GO(cairo_font_options_hash, LFp)
GO(cairo_font_options_merge, vFpp)
GO(cairo_font_options_set_antialias, vFpu)
GO(cairo_font_options_set_color_mode, vFpu)
GO(cairo_font_options_set_color_palette, vFpu)
GO(cairo_font_options_set_custom_palette_color, vFpudddd)
...
GO(cairo_font_options_set_variations, vFpp)
GO(cairo_font_options_status, uFp)
GO(cairo_format_stride_for_width, iFii)
GOM(cairo_ft_font_face_create_for_ft_face, pFEpi)
GOM(cairo_ft_font_face_create_for_pattern, pFEp)
...
GOM(cairo_ft_font_options_substitute, vFEpp)
GOM(cairo_ft_scaled_font_lock_face, pFEp)
GOM(cairo_ft_scaled_font_unlock_face, vFEp)
...
GO(cairo_pattern_get_dither, uFp)
...
GO(cairo_pattern_set_dither, vFpu)
...
GO(cairo_pdf_surface_add_outline, iFpippu)
...
GO(cairo_pdf_surface_set_custom_metadata, vFppp)
GO(cairo_pdf_surface_set_metadata, vFpup)
GO(cairo_pdf_surface_set_page_label, vFpp)
GO(cairo_pdf_surface_set_thumbnail_size, vFpii)
...
GOM(cairo_ps_surface_create_for_stream, pFEppdd)
...
GOM(cairo_raster_source_pattern_get_acquire, vFEppp)
...
GOM(cairo_script_create_for_stream, pFEpp)
...
GOM(cairo_svg_surface_create_for_stream, pFEppdd)
GO(cairo_svg_surface_get_document_unit, uFp)
GO(cairo_svg_surface_restrict_to_version, vFpu)
GO(cairo_svg_surface_set_document_unit, vFpu)
GO(cairo_svg_version_to_string, pFu)
GO(cairo_tag_begin, vFppp)
GO(cairo_tag_end, vFpp)
GO(cairo_tee_surface_add, vFpp)
GO(cairo_tee_surface_create, pFp)
GO(cairo_tee_surface_index, pFpu)
GO(cairo_tee_surface_remove, vFpp)
...
GOM(cairo_user_font_face_create, pFEv)
GOM(cairo_user_font_face_get_init_func, pFEp)
GOM(cairo_user_font_face_get_render_color_glyph_func, pFEp)
...
GOM(cairo_user_font_face_set_render_color_glyph_func, vFEpp)
...
GO(cairo_user_scaled_font_get_foreground_marker, pFp)
GO(cairo_user_scaled_font_get_foreground_source, pFp)
...
GO(cairo_xcb_device_debug_cap_xshm_version, vFpii)
...
GO(cairo_xlib_surface_create, pFpLpii)
