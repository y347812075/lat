...
// Linux OpenGL and OpenGL ES proc-address entry points.
...
GO(glBlitFramebufferLayerEXT, vFuuiiiiiiiiui)
GO(glBlitFramebufferLayersEXT, vFiiiiiiiiiu)
GO(glClipControlEXT, vFuu)
GO(glColorMaskiOES, vFuiiii)
...
GO(glCreateShaderProgramvEXT, uFuip)
GO(glDeleteProgramPipelinesEXT, vFip)
...
GO(glGetProgramPipelineInfoLogEXT, vFuipp)
GO(glGetProgramPipelineivEXT, vFuup)
...
GO(glIsEnablediOES, iFuu)
GO(glIsProgramPipelineEXT, iFu)
GO(glIsQueryEXT, iFu)
GO(glIsVertexArrayOES, iFu)
GO(glMapBufferOES, pFuu)
GO(glMinSampleShadingOES, vFf)
GO(glMultiDrawMeshTasksIndirectCountEXT, vFppii)
GO(glMultiDrawMeshTasksIndirectEXT, vFpii)
...
GO(glTexStorage3DMultisampleOES, vFuiuiiii)
