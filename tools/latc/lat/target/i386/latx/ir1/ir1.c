 ...
 * instructions as templates after the fixed hot decoder declines them.  The
 * cache is deliberately absent from normal JIT.
 */
                                         ...
                                         void *pir1_base, int mode)
{
    ...
    unsigned int id;
    switch (opcode) {
    case 0x89: id = dt_X86_INS_MOV; break;
    case 0x8b: id = dt_X86_INS_MOV; reverse = true; break;
    case 0x8d: id = dt_X86_INS_LEA; reverse = true; lea = true; break;
    case 0x85: id = dt_X86_INS_TEST; break;
    case 0x31: id = dt_X86_INS_XOR; break;
    case 0x33: id = dt_X86_INS_XOR; reverse = true; break;
    case 0x39: id = dt_X86_INS_CMP; break;
    case 0x3b: id = dt_X86_INS_CMP; reverse = true; break;
    case 0x01: id = dt_X86_INS_ADD; break;
    case 0x03: id = dt_X86_INS_ADD; reverse = true; break;
    case 0x29: id = dt_X86_INS_SUB; break;
    case 0x2b: id = dt_X86_INS_SUB; reverse = true; break;
    case 0x21: id = dt_X86_INS_AND; break;
    case 0x23: id = dt_X86_INS_AND; reverse = true; break;
    case 0x09: id = dt_X86_INS_OR; break;
    case 0x0b: id = dt_X86_INS_OR; reverse = true; break;
    default: return NULL;
    }
                 ...
                 void *pir1_base)
{
     ...
     */
    info = use_template && original_code ? ir1_hot_decode(
        addr, t_pc, ir1_num, pir1_base, CODEIS64) : NULL;
    bool hot_hit = info != NULL;
    if (!hot_hit && use_template && original_code) {
    ...
    if (use_template && original_code && !hot_hit && !template_hit) {
